...
import { sdl, testSuits } from './testsuites/objectModel';
...
describe('Tests on fixtures/object.graphql with Memory Data Source', function() {
  before(async () => {
...
describe('Tests on fixtures/object.graphql with MongoDB Data Source', function() {
  this.timeout(20000);
